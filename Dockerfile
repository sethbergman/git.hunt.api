...
##   $ docker build -t node-js-7-9-0-on-minideb .
##
## RUNNING
##   $ docker run -p 3000:3000 node-js-7-9-0-on-minideb
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="2p37rnn" \
    STACKSMITH_STACK_NAME="Node.js 7.9.0 on minideb" \
